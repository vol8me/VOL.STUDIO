...
import type {
  ...
  ShopOffer,
  ShopPickerLabels,
  ShopPickerLockOptions,
  ShopPickerOptions,
  ShopPickerRerollOptions,
  ShopPickerState,
  ShopSection,
} from './ShopPickerTypes';

// Veri sözleşmesi ayrı dosyada yaşar (bkz. `ShopPickerTypes.ts`); tüketiciler
// için bu modülden de görünür kalır, import yolları değişmez.
export type {
  ShopInventoryEntry,
  ShopOffer,
  ShopPickerLabels,
