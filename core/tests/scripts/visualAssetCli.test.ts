...
import { createVisualPreset, findVisualPresets } from '../../src/visual/catalog';
 ...
 */
const CLI = resolve(import.meta.dirname, '../../scripts/visual-asset.ts');
...
beforeAll(() => {
  workspace = mkdtempSync(join(tmpdir(), 'vol-visual-cli-'));
