...
/**
 * `core/src/visual/` DOM tanımaz ve Node-only kod barrel'a girmez — D8.
 *
 ...
 *    yüzden ayrıdır; görsel tarafta karşılığı `visual/encode/`dir.
 */
...
describe('görsel çekirdek headless kalmalı (D8)', () => {
  const root = join(import.meta.dirname, '../../src/visual');
