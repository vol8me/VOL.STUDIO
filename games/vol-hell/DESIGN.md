# VOL.HELL — tasarım kararları

Bu belge oyunun NEDEN böyle kurulduğunu tutar. Nasıl çalıştırılacağı ve hangi
komutların olduğu [README](README.md)'dedir — bir README tanıtımdır, karar
günlüğü değil.
